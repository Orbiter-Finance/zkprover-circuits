    ...
    fn plus(
        ...
        layouter.assign_region(
            ...
            |mut region: Region<'_, F>| {
                ...
                // Now we can assign the plus result, which is to be assigned
...
impl<F: Field> Circuit<F> for MyCircuit<F> {
    ...
    fn synthesize(
        ...
        //     _c2 = _c1^2
        //     c    = constant*_c2
        let _c1 = field_chip.plus(layouter.namespace(|| "a + b"), a, b)?;
        let _c2 = field_chip.mul(layouter.namespace(|| "_c1 * _c1"), _c1.clone(), _c1)?;
        let c = field_chip.mul(layouter.namespace(|| "constant * _c2"), constant, _c2)?;
