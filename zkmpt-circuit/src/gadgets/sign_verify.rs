...
use crate::gadgets::{
    sign_util::{not, rlc, Challenges, Expr},
    table::KeccakTable,
};
...
mod sign_verify_tests {
    ...
    use eth_types::{sign_types::{pk_bytes_le, pk_bytes_swap_endianness, SignData}, Field};
    use crate::gadgets::{
        sign_util::{not, rlc, Challenges, Expr},
        table::KeccakTable,
    };
    ...
    use halo2_proofs::{
        ...
        halo2curves::{
            bn256::Fr,
            group::{Curve, Group},
            CurveAffine, secp256k1::{Secp256k1Affine, self},
        },
    ...
    use super::{keccak_inputs_sign_verify, SignVerifyConfig, SignVerifyChip};
